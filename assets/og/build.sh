...
#
# Design (banner sibling): 1200x630, deep-ink ground, bronze I Ching
...
SANS="fonts/SpaceGrotesk-VF.ttf"        # brand sans
...
magick og.png -quality 92 -strip og.jpg

# Move the rendered cards to the repo root, where the site serves them.
mv -f og.png og.jpg ../../
echo "wrote og.png + og.jpg to repo root"
